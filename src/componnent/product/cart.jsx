              ...
              >
                <div className="border-[#D4AF37] sm:h-[206px] border sm:py-[30px] sm:pr-[36px] sm:pl-[37px] rounded mr-9">
                  <img
                    ...
                    alt={item.name}
                    width={75}
                    className="w-[79px] object-cover"
                  />
                </div>
                <div className="flex-1">
                  <h3 className="text-lg sm:text-3xl font-semibold pb-[15px]">
                    {item.name}
                  </h3>
                  <div className="flex items-center space-x-[31px]">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-2 sm:text-2xl">{item.quantity}</span>
                      <button
                        onClick={() =>
                          updateQuantity(item.id, item.quantity + 1)
                        }
                  ...
                  <p className="bg-[#00C62B24] rounded-xl border-[#00C62B] text-center px-[10px] py-2 my-4">
                    In stock
                  </p>
